...
const products = [
  ...
  // Салаты (день 1-7, неделя 1)
    ...
    { name: "Салат Витаминный", description: "Свежие овощи с растительным маслом", price: 70, categorySlug: "salads", image: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400&h=300&fit=crop", dayOfWeek: 1, weekType: 1, calories: 150, weight: 180 },
    { name: "Винегрет", description: "Овощной салат с растительным маслом", price: 65, categorySlug: "salads", image: "https://images.unsplash.com/photo-1623428454614-abaf00244e52?w=400&h=300&fit=crop", dayOfWeek: 2, weekType: 1, calories: 180, weight: 200 },
    { name: "Свекольный салат", description: "Тертая свекла с чесноком и орехами", price: 75, categorySlug: "salads", image: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400&h=300&fit=crop", dayOfWeek: 2, weekType: 1, calories: 160, weight: 180 },
    { name: "Салат из свежей капусты с зеленым горошком", description: "Нежная капуста с горошком", price: 27, categorySlug: "salads", image: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400&h=300&fit=crop", dayOfWeek: 3, weekType: 1, calories: 90, weight: 150 },
    { name: "Салат из фунчозы", description: "Фунчоза с овощами", price: 46, categorySlug: "salads", image: "https://images.unsplash.com/photo-1546793665-c74683f339c1?w=400&h=300&fit=crop", dayOfWeek: 3, weekType: 1, calories: 180, weight: 180 },
    { name: "Салат из свеклы с сыром и чесноком", description: "Свекла с сыром и чесноком", price: 32, categorySlug: "salads", image: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400&h=300&fit=crop", dayOfWeek: 4, weekType: 1, calories: 210, weight: 160 },
    { name: "Салат «Лагуна»", description: "Салат с морепродуктами", price: 57, categorySlug: "salads", image: "https://images.unsplash.com/photo-1546793665-c74683f339c1?w=400&h=300&fit=crop", dayOfWeek: 4, weekType: 1, calories: 220, weight: 200 },
    { name: "Салат «Грибная поляна»", description: "Салат с грибами и сыром", price: 56, categorySlug: "salads", image: "https://images.unsplash.com/photo-1546793665-c74683f339c1?w=400&h=300&fit=crop", dayOfWeek: 5, weekType: 1, calories: 240, weight: 190 },
    { name: "Салат «Легкий»", description: "Свежие овощи", price: 50, categorySlug: "salads", image: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400&h=300&fit=crop", dayOfWeek: 5, weekType: 1, calories: 120, weight: 180 },
