...
export default function TimeSlotPicker({ slots, selectedSlotId, onSelect }: TimeSlotPickerProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 max-h-[320px] overflow-y-auto pr-1 py-1">
        {filteredSlots.map(slot => {
          ...
          return (
            <button
              ...
              className={`
                relative px-3 py-2 rounded-md border-2 transition-all flex items-center justify-between gap-2
